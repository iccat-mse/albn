...
```{rabn-imp-xval3}
with(subset(x,X1==unique(X1)[2]),taylor.diagram(log(hat),log(obs),pos.cor=FALSE,normalize=TRUE,col="cyan",ref.sd=TRUE))

d_ply(x,.(X1),with, taylor.diagram(log(hat),log(obs),col="black",
