...
**Figure** Time series  of production parameters
...
**Figure** Relative time series of production parameters
...
ggplot(dat)+geom_point(aes(year,Recruitment))+
  theme_bw()
```
...
**Figure** Spectra for recruitment
```
